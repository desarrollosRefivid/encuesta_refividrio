var application_poll = new Vue({ 
    ...
    methods:{
        ...
        deleteData:async function(id){ 
          ...
          {
            const result = await axios.post('../php/bd_poll.php', {  action:'delete',  id:id }).then(function(response){  return response;  });
        ...
        showCopyPool(id,name){  
          ...
          this.modalCopy = true;  
            ...
            if (this.id_copy > 0) {
              const response = await axios.post('../php/bd_poll.php', {  
       ...
       ,
        async asingCompany(poll){ 
          ...
          const response = await axios.post('../php/bd_company_poll.php', {  action:'fetchall',id_encuesta:this.pollSelected.id_encuesta }).then(function(response){ return  response.data });
        ...
        async saveCompanys(){ 
          ...
          const response = await axios.post('../php/bd_company_poll.php', {  action:'delete',id_encuesta: this.pollSelected.id_encuesta }).then(function(response){ return  response.data });
          // console.log(response); 
          for (let index = 0; index < this.companys.length; index++) {
            const element = this.companys[index];
            if (element.selected) { 
              const response2 = await axios.post('../php/bd_company_poll.php', {  action:'insert',id_encuesta: this.pollSelected.id_encuesta,id_empresa: element.id_empresa }).then(function(response){ return  response.data });
