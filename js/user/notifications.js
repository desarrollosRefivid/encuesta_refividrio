...
var notification = new Vue({
    ...
    async viewNotification(_id_notification_detail,viewed){
        if (viewed == false) {
            const responce =  await axios.post('../../php/notification/bd_notification.php', {  action:'updateViewed',  id_notification_detail: _id_notification_detail })
     ...
     async fetchAllNotifications(){
        const responce = await axios.post('../../php/notification/bd_notification.php', {  action:'fetchallNotifications'  }).then(function(response){   return response.data;   });   
